  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView >
        ...
        <TouchableOpacity style={styles.account_btn} onPress={openWithdrawModal}>
        ...
        <Modal visible={isWithdrawModalOpen} animationType="slide" >
        <Withdraw closeWithdrawModal={closeWithdrawModal} balance={balance}/>
        </Modal>

        <TouchableOpacity style={styles.account_btn} onPress={openModal}>
        ...
        <TouchableOpacity style={styles.account_btn} onPress={openCurrentPlan}>
          <MaterialIcons name='event-available' size={28} color='#34C759' />
          <Text style={styles.btn_head}>Current Plan</Text>
          <Ionicons name='chevron-forward-outline' size={24} style={styles.forward_icon}></Ionicons>
        </TouchableOpacity>

        <Modal visible={isCurrentPlanOpen}  animationType="slide">
          <CurrentPlan closeCurrentModal={closeCurrentPlan}/>
        </Modal>
