      ...
      <ScrollView>
        ...
        <View style={styles.middle_container}>
          ...
          <Modal visible={isModalOpen} animationType="slide">
            <All_plans closeModal ={closeModal} balance={balance}/>
          </Modal>
        ...
        <View>
          <ScrollView horizontal={true} >
            <View style={styles.img_card}>
              ...
              <Image source={require('../assets/images/gold_card1.png')} style={styles.gold_img}>

              </Image>
            </View>
            <View style={[styles.img_card, { backgroundColor: '#CAC9C9' }]}>
              <Image source={require('../assets/images/silver_card.png')} style={styles.gold_img}>

              </Image>
            </View>
            <View style={[styles.img_card, { backgroundColor: '#BA8DF3' }]} >
              <Image source={require('../assets/images/platinum_card.png')} style={styles.gold_img}>
        ...
        <ScrollView>
          <TouchableOpacity style={styles.guide_btn} onPress={openGuideModal}>
          ...
          <Modal visible={isGuideModalOpen}>
            <Instructions closeModal={closeGuideModal} />
          </Modal>
        </ScrollView>
      </ScrollView>
    </SafeAreaView>
